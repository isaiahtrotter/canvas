...
// Framer-ready: all styling is inline (no Tailwind required).
// Framer will auto-install lucide-react from the import.
...
export default function ColorPicker() {
  ...
  const [zoom, setZoom] = useState<Zoom>(LIGHTS_ZOOM);
  const [rgb, setRgb] = useState<[number, number, number]>(hsvToRgb(0, 0, 100));
